...
@Repository
@Profile("dev")
public class ProdutoRepositoryMemory extends MemoryStore<Produto> implements ProdutoRepository {
    ...
    public Optional<Produto> buscarPorCodigoBarras(String oficinaId, String codigoBarras) {
        return primeiro(oficinaId, p -> codigoBarras != null && codigoBarras.equals(p.getCodigoBarras()));
    }
