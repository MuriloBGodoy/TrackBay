...
@Repository
@Profile("!dev")
public class VendaBalcaoRepositoryFirestore extends FirestoreStore<VendaBalcao>
        implements VendaBalcaoRepository {

    public VendaBalcaoRepositoryFirestore(Firestore db, ConversorFirestore conversor) {
        super(db, conversor, "vendas", VendaBalcao.class);
    }
